...
function loadAnotherTimeZone(para){
    newDate = new Date().toLocaleString('en-GB',{ timeZone: para });
    newTime = newDate.slice(newDate.indexOf(",")+2,);
    console.log(newDate.slice(newDate.indexOf(",")+2,));

    
    todayHours = Number(newTime.slice(0,2));
    todayMinutes = Number(newTime.slice(3,5));
    
    todaySeconds = Number(newTime.slice(6,));
...
loadAnotherTimeZone("Asia/Kuala_Lumpur");
// loadAnotherTimeZone("Australia/Perth"); //perth
// loadAnotherTimeZone("Europe/London"); // london
// loadAnotherTimeZone("Asia/Jakarta"); // jakarta
